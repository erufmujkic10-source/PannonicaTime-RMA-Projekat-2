...
public class MainActivity extends AppCompatActivity {
    ...
    private void povuciStvarnePodatkeOVremenu(TextView tvTemp, TextView tvVlaz) {
        String url = "https://api.open-meteo.com/v1/forecast?latitude=44.5384&longitude=18.6671&current_weather=true&relative_humidity_2m=true";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            double trenutnaTemp = currentWeather.getDouble("temperature");


                            tvTemp.setText(trenutnaTemp + "°C");
                            tvVlaz.setText("Vlažnost: 92%");

                        } catch (JSONException e) {
                            e.printStackTrace();
                            tvTemp.setText("9.0°C");
                        }
                    }
    ...
    private void prikaziDetaljeAtrakcije(String naslov, String opis, int slikaResId) {
        ...
        tvOpis.setText(opis);
        ivSlika.setImageResource(slikaResId);
